...
import com.khoinguyen.adapters.SongListAdapter;
import com.khoinguyen.helper.Music;
import com.khoinguyen.helper.Song;
import com.khoinguyen.helper.SongView;
import com.khoinguyen.services.MusicService;
...
public class ActivityDisplaySongs extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private Button mBtnImport,mBtnListDownload;
    ...
    private void addEvents() {
        mBtnListDownload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ActivityDisplaySongs.this, Activitylsmusic.class);
    ...
    private void addControls() {
        ...
        mBtnListDownload = (Button) findViewById(R.id.btn_import_lvdata);
    ...
    // lay toan bo duong dan den cua cac file trong may
    ...
    // method to detecting sdcard in phone
